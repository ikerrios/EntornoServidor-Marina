...
<table>
  ...
  <?php
  $keys = ['SERVER_NAME','SERVER_ADDR','SERVER_PORT','REQUEST_METHOD','REQUEST_URI','PHP_SELF','REMOTE_ADDR','HTTP_USER_AGENT','HTTP_ACCEPT_LANGUAGE','SCRIPT_FILENAME','HTTP_REFERER'];
  foreach ($keys as $k) {
